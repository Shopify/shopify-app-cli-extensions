  ...
  module Commands
    class RegisterTest < MiniTest::Test
      ...
      def test_does_not_run_create_if_user_does_not_confirm
        ...
        CLI::UI::Prompt.expects(:confirm).with(@context.message('register.confirm_question')).returns(false).once
      ...
      def test_creates_the_extension_if_user_confirms
        ...
        CLI::UI::Prompt.expects(:confirm).with(@context.message('register.confirm_question')).returns(true).once
